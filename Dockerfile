...
COPY --from=builder --chown=node:node /home/node/ormconfig.js ./ormconfig.js
COPY --from=builder --chown=node:node /home/node/g3ConnectConfig.js ./g3ConnectConfig.js
